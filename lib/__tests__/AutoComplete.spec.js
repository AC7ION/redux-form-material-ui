...
describe('AutoComplete', function () {
  ...
  it('renders an AutoComplete', function () {
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_AutoComplete2.default, { dataSource: dataSource, name: 'myAutoComplete', value: 'Foo',
      onNewRequest: _lodash2.default, onBlur: _lodash2.default, ref: 'component' }));
  });
  ...
  it('renders an AutoComplete with an error', function () {
    (0, _expect2.default)(new _AutoComplete4.default({
      ...
      errorText: 'FooError', onNewRequest: _lodash2.default, onBlur: _lodash2.default, ref: 'component' }));
  });
